      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            type="button"
          >
            {managementDictionary.createBrandButton}
          </button>
        </div>
      </div>
                ...
                <div key={productType.id} className="rounded-xl border border-slate-200 bg-white px-4 py-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      {productType.description ? (
                        <p className="mt-2 text-xs text-slate-500">{productType.description}</p>
                      ) : null}
                    </div>
                    <span
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      type="button"
                    >
                      {productType.is_active ? unitsDictionary.deactivateLabel : unitsDictionary.activateLabel}
                    </button>
                    <button
                ...
                <div key={unit.id} className="rounded-xl border border-slate-200 bg-white px-4 py-3">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      type="button"
                    >
                      {unit.is_active ? unitsDictionary.deactivateLabel : unitsDictionary.activateLabel}
                    </button>
                    <button
                      aria-label={unitsDictionary.deleteLabel}
                      className="rounded-lg border border-rose-200 p-1.5 text-rose-600 transition hover:bg-rose-50"
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-xs uppercase tracking-[0.18em] text-slate-500">
                {managementDictionary.brandsCountLabel}
              </p>
            </div>
            <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-slate-700">
                ...
                <div key={brand.id} className="rounded-xl border border-slate-200 bg-white px-4 py-3">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      type="button"
                    >
                      {brand.is_active ? unitsDictionary.deactivateLabel : unitsDictionary.activateLabel}
                    </button>
                    <button
                      aria-label={unitsDictionary.deleteLabel}
                      className="rounded-lg border border-rose-200 p-1.5 text-rose-600 transition hover:bg-rose-50"
